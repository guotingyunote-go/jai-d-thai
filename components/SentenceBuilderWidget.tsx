...
const styles = StyleSheet.create({
    ...
    chip: { flex: 1, padding: 10, borderRadius: 16, borderWidth: 1, alignItems: 'center' },
    chipLabel: { fontFamily: 'Kanit', fontSize: 10, color: '#BBB' },
    chipThai: { fontSize: 22, letterSpacing: 0.5 },
    chipPhonetic: { fontFamily: 'Kanit', fontSize: 11, color: '#AAA' },
    chipZh: { fontFamily: 'Prompt_500Medium', fontSize: 12, color: '#777', marginTop: 2 },
    ...
    mainSpeakText: { color: '#FFF', fontFamily: 'Kanit_600SemiBold', fontSize: 16 },
    ...
    modalTitle: { fontFamily: 'Prompt_700Bold', fontSize: 20 },
    ...
    pickerThai: { fontSize: 24, color: '#333', letterSpacing: 0.5 },
    pickerSub: { fontSize: 14, color: '#888', marginTop: 4 },
