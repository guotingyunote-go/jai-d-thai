...
const styles = StyleSheet.create({
    ...
    thaiBlock: { flex: 2 },
    thaiWord: { fontFamily: 'Kanit_600SemiBold', fontSize: 32, letterSpacing: 3, lineHeight: 42 },
    phonetic: { fontFamily: 'Kanit', fontSize: 17, color: '#AAA', marginTop: 4 },
    meaningBlock: { flex: 2, alignItems: 'flex-start', gap: 6 },
    zhTW: { fontFamily: 'Prompt_500Medium', fontSize: 22, color: '#333' },
    ...
    noteText: { fontFamily: 'Kanit', fontSize: 20, color: '#666', lineHeight: 26 },
});
