...
const styles = StyleSheet.create({
    ...
    thaiBlock: { flex: 2 },
    thaiWord: { fontFamily: 'Kanit_600SemiBold', fontSize: 24 },
    phonetic: { fontFamily: 'Kanit', fontSize: 12, color: '#AAA', marginTop: 1 },
    meaningBlock: { flex: 2, alignItems: 'flex-start', gap: 4 },
    zhTW: { fontFamily: 'Prompt_500Medium', fontSize: 16, color: '#333' },
    toneBadge: { paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6 },
    toneText: { fontFamily: 'Kanit', fontSize: 11, fontWeight: '600' },
    audioBtn: { width: 44, height: 44, borderRadius: 22, backgroundColor: '#F5F5F5', alignItems: 'center', justifyContent: 'center' },
    audioIcon: { fontSize: 18, color: '#666' },
    noteBox: { marginTop: 12, paddingTop: 10, borderTopWidth: 1 },
    noteText: { fontFamily: 'Kanit', fontSize: 13, color: '#777', lineHeight: 18 },
});
