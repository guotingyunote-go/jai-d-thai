...
const styles = StyleSheet.create({
    ...
    location: { fontFamily: 'Kanit', fontSize: 17, color: '#AAA', marginBottom: 4 },
    scenarioText: { fontFamily: 'Prompt_500Medium', fontSize: 24, color: '#333' },
    bubble: {
    ...
    thaiMain: { fontFamily: 'Kanit_600SemiBold', fontSize: 32, color: '#222' },
    ...
    optionText: { fontFamily: 'Kanit', fontSize: 20, fontWeight: '600', color: '#555' },
    ...
    feedbackTitle: { fontFamily: 'Kanit_600SemiBold', fontSize: 22, marginBottom: 8 },
    feedbackContent: { fontFamily: 'Kanit', fontSize: 18, color: '#666', lineHeight: 20, marginBottom: 16 },
    ...
    meterLabel: { fontFamily: 'Kanit', fontSize: 17, color: '#888' },
    meterValue: { fontFamily: 'Kanit_600SemiBold', fontSize: 17, color: '#7851A9' },
