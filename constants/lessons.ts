...
export const LESSONS = [
  ...
  },
  {
    ...
    letterClass: '高聲調類',
    emoji: '🥚',
    svgPath: 'M 25,35 A 8 8 0 1 1 41 35 A 8 8 0 0 1 25 35 M 25,35 C 10,50 10,85 45,85 L 75,85',
    pathLength: 220,
    startPoint: { cx: 25, cy: 35 },
  ...
  },
  {
    ...
    letterClass: '高聲調類',
    emoji: '🍾',
    svgPath: 'M 25,35 A 8 8 0 1 1 41 35 A 8 8 0 0 1 25 35 M 25,35 C 35,40 35,50 25,55 C 10,70 10,85 45,85 L 75,85',
    pathLength: 220,
    startPoint: { cx: 25, cy: 35 },
  ...
  },
  {
    ...
    letterClass: '低聲調類',
    emoji: '🐃',
    svgPath: 'M 35,25 A 8 8 0 1 0 51 25 A 8 8 0 0 0 35 25 M 35,25 C 20,15 15,30 15,50 L 15,85 M 15,50 C 15,10 80,10 80,50 L 80,85',
    pathLength: 220,
    startPoint: { cx: 25, cy: 35 },
  ...
  },
  {
    ...
    letterClass: '低聲調類',
    emoji: '🐍',
    svgPath: 'M 40,25 A 8 8 0 1 0 56 25 A 8 8 0 0 0 40 25 M 48,33 L 48,70 L 15,90',
    pathLength: 220,
    startPoint: { cx: 25, cy: 35 },
  ...
  },
  {
    ...
    letterClass: '中聲調類',
    emoji: '🍽️',
    svgPath: 'M 40,45 A 8 8 0 1 1 56 45 A 8 8 0 0 1 40 45 M 40,45 C 30,50 30,70 45,70 L 60,70 C 80,70 80,40 60,20',
    pathLength: 220,
    startPoint: { cx: 25, cy: 35 },
  ...
  },
  {
    ...
    letterClass: '低聲調類',
    emoji: '🐘',
    svgPath: 'M 30,35 A 8 8 0 1 0 46 35 A 8 8 0 0 0 30 35 M 30,35 C 15,50 15,85 45,85 L 70,85 L 70,40 A 15 15 0 0 1 90 20',
    pathLength: 220,
    startPoint: { cx: 25, cy: 35 },
  ...
  },
  {
    ...
    letterClass: '中聲調類',
    emoji: '🐢',
    svgPath: 'M 25,35 A 8 8 0 1 1 41 35 A 8 8 0 0 1 25 35 M 41,35 C 41,50 25,50 25,65 L 25,85 M 25,35 C 25,10 50,10 50,25 C 50,10 80,10 80,35 L 80,85',
    pathLength: 220,
    startPoint: { cx: 25, cy: 35 },
  ...
  },
  {
    ...
    letterClass: '低聲調類',
    emoji: '🐭',
    svgPath: 'M 25,25 A 8 8 0 1 0 41 25 A 8 8 0 0 0 25 25 M 25,25 L 25,75 T 45 75 A 10 10 0 1 0 65 75 L 65,15',
    pathLength: 220,
    startPoint: { cx: 25, cy: 35 },
  ...
  },
  {
    ...
    letterClass: '中聲調類',
    emoji: '🍃',
    svgPath: 'M 25,25 A 8 8 0 1 0 41 25 A 8 8 0 0 0 25 25 M 25,25 L 25,85 L 75,85 L 75,25',
    pathLength: 220,
    startPoint: { cx: 25, cy: 35 },
  ...
  },
  {
    ...
    letterClass: '中聲調類',
    emoji: '🐟',
    svgPath: 'M 25,25 A 8 8 0 1 0 41 25 A 8 8 0 0 0 25 25 M 25,25 L 25,85 L 75,85 L 75,10',
    pathLength: 220,
    startPoint: { cx: 25, cy: 35 },
  ...
  },
  {
    ...
    letterClass: '高聲調類',
    emoji: '🐝',
    svgPath: 'M 20,35 A 8 8 0 1 1 36 35 A 8 8 0 0 1 20 35 M 20,35 L 20,85 L 45,55 L 70,85 L 70,20',
    pathLength: 220,
    startPoint: { cx: 25, cy: 35 },
  ...
  },
  {
    ...
    letterClass: '低聲調類',
    emoji: '��',
    svgPath: 'M 20,35 A 8 8 0 1 0 36 35 A 8 8 0 0 0 20 35 M 20,35 L 20,85 L 45,55 L 70,85 L 70,20',
    pathLength: 220,
    startPoint: { cx: 25, cy: 35 },
  ...
  },
  {
    ...
    letterClass: '低聲調類',
    emoji: '🐴',
    svgPath: 'M 25,25 A 8 8 0 1 0 41 25 A 8 8 0 0 0 25 25 M 25,25 L 25,75 A 10 10 0 1 0 45 75 L 80,75 L 80,15',
    pathLength: 220,
    startPoint: { cx: 25, cy: 35 },
  ...
  },
  {
    ...
    letterClass: '低聲調類',
    emoji: '🚤',
    svgPath: 'M 20,65 A 8 8 0 1 0 36 65 A 8 8 0 0 0 20 65 M 20,65 L 20,35 C 20,10 50,10 50,25 C 50,10 80,10 80,25',
    pathLength: 220,
    startPoint: { cx: 25, cy: 35 },
  ...
  },
  {
    ...
    letterClass: '低聲調類',
    emoji: '🐒',
    svgPath: 'M 35,65 A 8 8 0 1 1 51 65 A 8 8 0 0 1 35 65 M 51,65 L 51,85 L 20,85 L 20,35 C 20,10 80,10 80,35',
    pathLength: 220,
    startPoint: { cx: 25, cy: 35 },
  ...
  },
  {
    ...
    letterClass: '高聲調類',
    emoji: '🐯',
    svgPath: 'M 35,65 A 8 8 0 1 1 51 65 A 8 8 0 0 1 35 65 M 51,65 L 51,85 L 20,85 L 20,35 C 20,10 80,10 80,35 M 65,15 L 85,5',
    pathLength: 220,
    startPoint: { cx: 25, cy: 35 },
  ...
  },
  {
    ...
    letterClass: '中聲調類',
    emoji: '🛁',
    svgPath: 'M 35,35 A 8 8 0 1 1 51 35 A 8 8 0 0 1 35 35 M 35,35 C 20,40 20,85 45,85 L 75,85 L 75,15 C 50,15 50,35 50,35',
    pathLength: 220,
    startPoint: { cx: 25, cy: 35 },
