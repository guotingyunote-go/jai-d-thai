...
const styles = StyleSheet.create({
    ...
    appBrand: { flexDirection: 'row', alignItems: 'baseline', gap: 6 },
    appNameThai: { fontFamily: 'Kanit_600SemiBold', fontSize: 32 },
    appNameZH: { fontFamily: 'Kanit_600SemiBold', fontSize: 18, color: '#888' },
    modeBadge: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 16, alignSelf: 'flex-start' },
    modeBadgeText: { fontFamily: 'Kanit', fontSize: 15, fontWeight: '600' },
